  ...
  return (
    <AdminLayout>
      <div className="space-y-8">
        ...
        >
          <div>
            <p className="pill w-fit">Portfolio</p>
            <h1 className="text-3xl font-bold text-foreground">Manage portfolio projects</h1>
            <p className="text-muted-foreground">Create, edit, and feature portfolio items.</p>
          </div>
                ...
                <div>
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {formData.images.map((img: string, idx: number) => (
                      <div key={idx} className="flex items-center gap-1 rounded bg-muted px-2 py-1 text-xs text-foreground">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            ...
            >
              <Card className="surface-card h-full overflow-hidden border border-border/60">
                {project.image_url && (
                ...
                <CardContent className="space-y-3 p-4">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <Badge variant="secondary" className="shrink-0 rounded-full">{project.type}</Badge>
                  </div>
                  {project.featured && <Badge className="rounded-full">Featured</Badge>}
